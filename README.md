...
- **Resolution**: 112×112 to 640×480 pixels
...
### **Endoscopy Data (Confidential) **
- **Echocardiography videos** from local hospital data (Public Hospital in New Rochelle)
- **Size**: ~50+ GB
...
<table>
  <tr>
    <td align="center">
      <img src="0X18BA5512BE5D6FFA.gif" width="350"/>
      <br/>
      <sub>EchoNet-Dynamic</sub>
    </td>
    <td align="center">
      <img src="Segmentationdataexample.gif" width="350"/>
      <br/>
      <sub>SurgiS4K</sub>
    </td>
  </tr>
...
# results/
# ├── echonet/          # Training curves, segmentation videos
# ├── surgis4k/         # SAM2 overlays, mask coverage statistics
...
- Downscale 4K → 480p/540p/1080p for computational efficiency
...
1. **Supervised (EchoNet) Advantages:**
   - ✅ Task-specific optimization (cardiac ventricle focus)
   - ✅ Quantitative clinical outputs (EF prediction)
   - ✅ High accuracy on domain-specific data
   - ❌ Requires manual annotation (expensive)
   - ❌ Doesn't generalize to other organs/domains

2. **Zero-Shot (SAM2) Advantages:**
   - ✅ Works immediately without training
   - ✅ Generalizes across organs and anatomies
   - ✅ Zero annotation cost (significant for medical data)
   - ✅ Can be applied to any medical video
...
- Deep learning pipeline development (data → model → evaluation)
